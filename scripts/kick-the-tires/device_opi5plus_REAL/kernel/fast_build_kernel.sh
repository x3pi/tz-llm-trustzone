...
echo "We don't cp kernel source"
#cp -arf ${KERNEL_SOURCE}/* ${KERNEL_SRC_TMP_PATH}/

echo "cp -r ${KERNEL_SOURCE}/drivers/rknpu/ ${KERNEL_SRC_TMP_PATH}/drivers/rknpu/"
cp -arf ${KERNEL_SOURCE}/drivers/rknpu/* ${KERNEL_SRC_TMP_PATH}/drivers/rknpu/
cp -arf ${KERNEL_SOURCE}/arch/arm64/mm/init.c ${KERNEL_SRC_TMP_PATH}/arch/arm64/mm/init.c
cp -arf ${KERNEL_SOURCE}/drivers/dma-buf/heaps/cma_heap.c ${KERNEL_SRC_TMP_PATH}/drivers/dma-buf/heaps/cma_heap.c
cp -arf ${KERNEL_SOURCE}/drivers/iommu/rockchip-iommu.c ${KERNEL_SRC_TMP_PATH}/drivers/iommu/rockchip-iommu.c
cp -arf ${KERNEL_SOURCE}/mm/cma.c ${KERNEL_SRC_TMP_PATH}/mm/cma.c
...
#atch -p1 < ${PATCHES_PATH}/tzdriver.patch

#p -rf ${DEVICE_DIR}/kernel/make*.sh ${KERNEL_SRC_TMP_PATH}/
#config
#p -rf ${KERNEL_CONFIG_FILE} ${KERNEL_SRC_TMP_PATH}/arch/arm64/configs/${DEFCONFIG_FILE}
