...
#ifdef OHOS_USE_X11
#define OHOS_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_X11_KHR
#elif  OHOS_USE_WAYLAND
#define OHOS_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_WAYLAND_KHR
#elif  OHOS_USE_DRM
#define OHOS_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_GBM_KHR
#elif  OHOS_USE_MIR
#define OHOS_NATIVE_EGL_DISPLAY_ENUM EGL_PLATFORM_MIR_KHR
#else
// Platforms not in the above platform enums fall back to eglGetDisplay.
#define OHOS_NATIVE_EGL_DISPLAY_ENUM 0
#endif
...
GLStateEGL::gotValidDisplay()
{
    ...
    if (OHOS_NATIVE_EGL_DISPLAY_ENUM != 0 && supported_extensions
