...
cap_t chcore_pthread_create(pthread_t *__restrict,
                            const pthread_attr_t *__restrict, void *(*)(void *),
                            void *__restrict);
cap_t chcore_pthread_create_shadow(pthread_t *__restrict,
                                   const pthread_attr_t *__restrict,
                                   void *(*)(void *), void *__restrict);
cap_t chcore_pthread_create_register_cb(pthread_t *__restrict,
                                        const pthread_attr_t *__restrict,
                                        void *(*)(void *), void *__restrict);
