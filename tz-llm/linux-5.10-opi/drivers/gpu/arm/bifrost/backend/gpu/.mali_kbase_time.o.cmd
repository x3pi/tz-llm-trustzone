cmd_drivers/gpu/arm/bifrost/backend/gpu/mali_kbase_time.o := aarch64-linux-gnu-gcc -Wp,-MMD,drivers/gpu/arm/bifrost/backend/gpu/.mali_kbase_time.o.d -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/13/include -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -DCC_USING_PATCHABLE_FUNCTION_ENTRY -DKASAN_SHADOW_SCALE_SHIFT= -fmacro-prefix-map=./= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -mgeneral-regs-only -DCONFIG_CC_HAS_K_CONSTRAINT=1 -Wno-psabi -mabi=lp64 -fno-asynchronous-unwind-tables -fno-unwind-tables -mbranch-protection=pac-ret+leaf+bti -Wa,-march=armv8.5-a -DARM64_ASM_ARCH='"armv8.5-a"' -DKASAN_SHADOW_SCALE_SHIFT= -fno-delete-null-pointer-checks -Wno-frame-address -Wno-format-truncation -Wno-format-overflow -Wno-address-of-packed-member -Os -fno-allow-store-data-races -Wframe-larger-than=2048 -fstack-protector-strong -Wimplicit-fallthrough -Wno-unused-but-set-variable -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fpatchable-function-entry=2 -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-restrict -Wno-maybe-uninitialized -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init -Wno-packed-not-aligned -mstack-protector-guard=sysreg -mstack-protector-guard-reg=sp_el0 -mstack-protector-guard-offset=1344 -DMALI_CUSTOMER_RELEASE=0 -DMALI_USE_CSF=1 -DMALI_KERNEL_TEST_API=1 -DMALI_UNIT_TEST=1 -DMALI_COVERAGE=0 -DMALI_RELEASE_NAME='"g13p0-01eac0"' -DMALI_JIT_PRESSURE_LIMIT_BASE=0 -DMALI_INCREMENTAL_RENDERING_JM=0 -DMALI_PLATFORM_DIR=rk -DMALI_KBASE_PLATFORM_PATH=../.././drivers/gpu/arm/bifrost/platform/"rk" -I./include/linux -I./drivers/staging/android -I./drivers/gpu/arm/bifrost -I./drivers/gpu/arm/bifrost/platform/rk -I./drivers/gpu/arm/bifrost/../../../base -I./drivers/gpu/arm/bifrost/../../../../include -DMALI_CUSTOMER_RELEASE=0 -DMALI_USE_CSF=1 -DMALI_KERNEL_TEST_API=1 -DMALI_UNIT_TEST=1 -DMALI_COVERAGE=0 -DMALI_RELEASE_NAME='"g13p0-01eac0"' -DMALI_JIT_PRESSURE_LIMIT_BASE=0 -DMALI_INCREMENTAL_RENDERING_JM=0 -DMALI_PLATFORM_DIR=rk -DMALI_KBASE_PLATFORM_PATH=../.././drivers/gpu/arm/bifrost/platform/"rk" -I./include/linux -I./drivers/staging/android -I./drivers/gpu/arm/bifrost -I./drivers/gpu/arm/bifrost/platform/rk -I./drivers/gpu/arm/bifrost/../../../base -I./drivers/gpu/arm/bifrost/../../../../include    -DKBUILD_MODFILE='"drivers/gpu/arm/bifrost/bifrost_kbase"' -DKBUILD_BASENAME='"mali_kbase_time"' -DKBUILD_MODNAME='"bifrost_kbase"' -D__KBUILD_MODNAME=kmod_bifrost_kbase -c -o drivers/gpu/arm/bifrost/backend/gpu/mali_kbase_time.o drivers/gpu/arm/bifrost/backend/gpu/mali_kbase_time.c
